...
{
    internal class AddPrefabToSceneMenu
    {
        ...
        {
            GameObject instance = AddPrefabToScene("07a8344aed11c464d9ca30fde8ee3351"); // OnScreenUI.prefab
        ...
        public static GameObject AddPrefabToScene(string guid)
        {
